			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="comment.member.label" default="Member" /></th>
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${commentInstance.id}">${fieldValue(bean: commentInstance, field: "member")}</g:link></td>
